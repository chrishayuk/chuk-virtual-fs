...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if os.path.exists(local_file):
        ...
        with open(local_file, "rb") as file:
            fs.write_file("/web_project/uploads/example.txt", file.read().decode('utf-8'))
...
def e2b_sandbox_persistence():
    ...
    fs1.write_file("/persistent_data/config.json", '{"setting": "value", "enabled": true}')
    ...
    fs2 = VirtualFileSystem("e2b", sandbox_id=sandbox_id, root_dir="/home/user/persistence_test")
    ...
    if reconnect_files:
        ...
        print("No files found after reconnection - persistence may not be working as expected")
    
    # Add a new file to the reconnected sandbox
    print("\nAdding a new file to the reconnected sandbox...")
    fs2.write_file("/persistent_data/new_after_reconnect.txt", "This file was added after reconnection")
