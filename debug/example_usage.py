"""
debug/example_usage.py - Example usage of the virtual filesystem
"""
...
def provider_example():
    ...
    try:
        ...
        s3_fs = VirtualFileSystem(
            "s3", bucket_name="my-test-bucket", region_name="us-east-1"
        )
...
def template_example():
    ...
    template_loader.apply_template(
        python_project_template, variables=template_variables
    )
    ...
    main_script_content = fs.read_file(
        "/projects/awesome_project/src/awesome_project/main.py"
    )
